...
<link rel="stylesheet" href="css/custom.css">
    <!----Dropdown CSS in login page -->
    <link rel="stylesheet" type="text/css" href="Forms/Login_form/css/dropdown.css">
			...
			<div class="container">
				...
				<div class="collapse navbar-collapse justify-content-end"
					...
					<ul class="navbar-nav">
						...
						<div class="dropdown">
							<li><button class="dropbtn">Login </button></li>
							 <div class="dropdown-content">
								  <a href="src\main\webapp\WEB-INF\view\patientLogin.jsp">Patient</a>
								  <a href="src\main\webapp\WEB-INF\view\doctorLogin.jsp">Doctor</a>
					...
					<!-----	<li><a class="nav-link" href="/signup">Sign up</a></li>---->
						<div class="dropdown">
							<li><button class="dropbtn">Sign up</button></li>
							 <div class="dropdown-content">
								  <a href="src\main\webapp\WEB-INF\view\patientSignup.jsp">Patient</a><br>
								  <a href="src\main\webapp\WEB-INF\view\doctorSignup.jsp">Doctor</a>
